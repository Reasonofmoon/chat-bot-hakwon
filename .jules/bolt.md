...
## 2025-02-25 - Regex Hoisting
**Learning:** Defining regex literals inside render functions (e.g., `const regex = /.../`) creates a new RegExp object on every render. Hoisting them to module-level constants prevents this allocation.
**Action:** Always hoist static regexes used in validation or parsing logic outside of the component body.
