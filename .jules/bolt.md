...
## 2025-02-23 - Static SVG Children & Layer Promotion
**Learning:** For purely presentational SVG components like Spinners, extracting static paths to module-level constants avoids re-creating React elements on every render.
**Action:** Combined with `will-change: transform` on the animated element, this minimizes main-thread work during animation loops.
